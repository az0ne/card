...
$add_money = htmlspecialchars($_POST['add_money']);
$user_query = mysql_query("select * from user_money where uid=$userid limit 1");
$row = mysql_fetch_array($user_query);
$user_money = $add_money + $row['user_money'];
...
$time = time();
$yue = $row2['user_money'];
$sql2 = "INSERT INTO money_log(uid,addlog,yue,time)VALUES('$userid','$log','$yue','$time')";
